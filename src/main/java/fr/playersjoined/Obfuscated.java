// This script, was made by an AI not an tool! (i don't know how to obfuscate just this) DO NOT ASK ME, WHAT AI I USE FOR OBFUSCATE THIS CODE, ON THIS CODE I NOT ASK THE AI TO PUT SOME MALICIOUS THINGS IT'S JUST NOTHINGS MALICIOUS.
// Also this mod is in LICENSE MIT, so if you want just compile just rename this "Obfusacted.java" /// Information: But just i don't know why, you need do that because I remind you, that it's under the MIT License so i don't know why but i continue anyway, in "PlayersJoinedMod.java" and delete the old "PlayersJoinedMod.java", and you compile and you will get the .jar, it's just for the code do not get exposed, is real source code basically i made this script, because the mod was an private things basically, (the mod was leaked, but not open source so i made this script, for it's very hard to get read so yeah) basically but i decide, to put it open source on github. 
